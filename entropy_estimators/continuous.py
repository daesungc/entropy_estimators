...
@convert_vectors_to_2d_arrays_if_any
def get_h(x, k=1, norm='max', min_dist='auto', workers=1):
	"""
	...
	min_dist: float (default 'auto')
		minimum distance between data points;
		smaller distances will be capped using this value;
		'auto' sets the min_dist as the smallest distance > 0
	...
	# calculate min_dist as the smallest distances greater than 0.0
	if min_dist == 'auto':
